...
function AnxietyTest({ onComplete, onBack }) {
            ...
            <div className="specialized-test-banner anxiety-banner">
                <div>
                    ...
                    <p className="specialized-test-banner-subtitle">
                        Identify anxiety intensity and common emotional triggers.
                    </p>
                </div>
            </div>
                    ...
                    {!loading && !error && (
                        <>
                            <div className="screen-header">
                                <h2 className="screen-title">Anxiety Assessment</h2>
                                <p className="screen-description">
                                    Please answer the following {questions.length} questions about your anxiety levels.
                                </p>
                            </div>
