...
function BurnoutTest({ onComplete, onBack }) {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            try {
                ...
                const url = `http://localhost:5000/api/domains/questions-by-domains/Burnout${specTypeId ? `?assessment_type_id=${specTypeId}` : ''}`;
            ...
            <div className="specialized-test-banner burnout-banner">
                <div>
                    ...
                    <p className="specialized-test-banner-subtitle">
                        Measure emotional exhaustion and academic fatigue signs.
                    </p>
                </div>
            </div>
                    ...
                    {!loading && !error && (
                        <>
                            <div className="screen-header">
                                <h2 className="screen-title">Burnout Assessment</h2>
                                <p className="screen-description">
                                    Please answer the following {questions.length} questions about your energy and fatigue levels.
                                </p>
                            </div>
