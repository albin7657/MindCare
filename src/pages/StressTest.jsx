...
function StressTest({ onComplete, onBack }) {
            ...
            <div className="specialized-test-banner stress-banner">
                <div>
                    ...
                    <p className="specialized-test-banner-subtitle">
                        Understand your current stress load and daily pressure patterns.
                    </p>
                </div>
            </div>
                    ...
                    {!loading && !error && (
                        <>
                            <div className="screen-header">
                                <h2 className="screen-title">Stress Assessment</h2>
                                <p className="screen-description">
                                    Please answer the following {questions.length} questions about your stress levels.
                                </p>
                            </div>
