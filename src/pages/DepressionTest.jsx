...
function DepressionTest({ onComplete, onBack }) {
            ...
            <div className="specialized-test-banner depression-banner">
                ...
                <div>
                    ...
                    <p className="specialized-test-banner-subtitle">
                        Screen low mood patterns and loss of interest over time.
                    </p>
                </div>
            </div>
                    ...
                    {!loading && !error && (
                        <>
                            <div className="screen-header">
                                <h2 className="screen-title">Depression Assessment</h2>
                                <p className="screen-description">
                                    Please answer the following {questions.length} questions about your mood and interest levels.
                                </p>
                            </div>
